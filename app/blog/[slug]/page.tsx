...
export default function ArticlePage() {
    ...
    return (
      <div className="min-h-screen bg-slate-950 text-slate-200">
        ...
        <div className="pt-32 px-6 max-w-5xl mx-auto">
          ...
          <Link href="/blog" className="text-emerald-400 underline mt-6 inline-block">
            Back to blog
          </Link>
        </div>
        <Footer />
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <div className="pt-32 px-6 max-w-5xl mx-auto">
        <Link href="/blog" className="text-emerald-400 uppercase text-xs font-black">
          ← Back to blog
        </Link>
            ...
            <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-10">
              {relatedArticles.map((a) => (
                <Link
                  key={a.Slug}
                  href={`/blog/${a.Slug}`}
                  className="group rounded-[2.5rem] border border-white/10 overflow-hidden flex flex-col hover:border-emerald-500/30 transition-all duration-500 shadow-2xl bg-slate-950"
                >
                  <div className="relative h-44 overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900">
                    ...
                    <div className="absolute top-5 left-5 px-4 py-1.5 bg-emerald-500/90 backdrop-blur-md text-white text-[10px] font-black uppercase rounded-full">
                      {a.wp_category}
                    </div>
                  </div>
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center gap-2 text-emerald-400 font-black uppercase tracking-widest text-[10px] mt-auto">
