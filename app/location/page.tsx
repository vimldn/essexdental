...
export default function LocationPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          <div className="text-center space-y-6">
            <h1 className="text-4xl md:text-7xl font-black text-slate-900 leading-tight tracking-tight">
              Find Your Local{' '}
              <span className="italic text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-green-500">
                Implant Specialist
              </span>
            </h1>
          ...
          {selectedCity && (
            <div className="bg-emerald-50/50 p-8 md:p-12 rounded-[2.5rem] border border-emerald-200 flex flex-col md:flex-row items-center justify-between gap-8">
  ...
  className={`text-left px-6 py-5 rounded-2xl border transition-all font-bold text-base sm:text-lg leading-relaxed flex items-center justify-between group ${
    selectedCity === city
      ...
      : 'bg-slate-50 border-slate-100 text-slate-600 hover:border-emerald-300 hover:text-slate-900 hover:bg-white hover:shadow-md'
  }`}
  onClick={(e) => {
