...
export default function LocationPage() {
          ...
          <div className="text-center space-y-6">
            ...
            <div className="max-w-xl mx-auto relative mt-8 flex items-center">
              ...
              <input
                ...
                className="w-full bg-slate-900/50 border border-white/10 rounded-2xl px-6 py-5 pl-16 text-white focus:border-emerald-500 outline-none transition-all shadow-2xl"
              />
            </div>
          </div>

          {selectedCity && (
            <div className="dark-card p-8 md:p-12 rounded-[2.5rem] border border-emerald-500/20 bg-emerald-500/5 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <button
                ...
                className="px-10 py-5 bg-emerald-500 text-white font-black rounded-full shadow-2xl hover:scale-105 transition-all"
              >
  ...
  className={`text-left px-6 py-5 rounded-2xl border transition-all font-bold text-base sm:text-lg leading-relaxed flex items-center justify-between group ${
    selectedCity === city
      ...
      : 'bg-slate-900/40 border-white/5 text-slate-300 hover:border-emerald-500/30 hover:text-white hover:bg-slate-800/40'
  }`}
  onClick={(e) => {
