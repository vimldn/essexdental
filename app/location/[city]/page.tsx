        ...
        <div className="max-w-7xl mx-auto px-4 space-y-16">
          <div className="text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 rounded-full border border-white/10 text-sm text-slate-400 mb-4">
              <Link href="/location" className="hover:text-emerald-400 transition-colors">All Locations</Link>
              <span>/</span>
              <span className="text-white">{cityName}</span>
            </div>

            <h1 className="text-4xl md:text-7xl font-black text-white leading-tight">
              Dental Implants in <span className="text-emerald-400 italic">{cityName}</span>
            </h1>
          ...
          <div className="dark-card p-8 md:p-12 rounded-[2.5rem] border border-emerald-500/20 bg-emerald-500/5">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="space-y-4 text-center md:text-left">
                <h2 className="text-3xl font-bold text-white">Start Your Journey in {cityName}</h2>
