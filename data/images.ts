...
export const IMAGES = {
  ...
  locations: {
    chelmsford: {
      heroSide: { src: '/images/locations/chelmsford.jpg', alt: 'Chelmsford editorial location image.', width: 1600, height: 900 },
    },
    colchester: {
      heroSide: { src: '/images/locations/colchester.jpg', alt: 'Colchester editorial location image.', width: 1600, height: 900 },
    },
    'southend-on-sea': {
      heroSide: { src: '/images/locations/southend-on-sea.jpg', alt: 'Southend-on-Sea editorial location image.', width: 1600, height: 900 },
    },
    basildon: {
      heroSide: { src: '/images/locations/basildon.jpg', alt: 'Basildon editorial location image.', width: 1600, height: 900 },
    },
    brentwood: {
      heroSide: { src: '/images/locations/brentwood.jpg', alt: 'Brentwood editorial location image.', width: 1600, height: 900 },
    },
    billericay: {
      heroSide: { src: '/images/locations/billericay.jpg', alt: 'Billericay editorial location image.', width: 1600, height: 900 },
    },
    witham: {
      heroSide: { src: '/images/locations/witham.jpg', alt: 'Witham editorial location image.', width: 1600, height: 900 },
    },
    harlow: {
      heroSide: { src: '/images/locations/harlow.jpg', alt: 'Harlow editorial location image.', width: 1600, height: 900 },
    },
    'clacton-on-sea': {
      heroSide: { src: '/images/locations/clacton-on-sea.jpg', alt: 'Clacton-on-Sea editorial location image.', width: 1600, height: 900 },
    },
    rayleigh: {
      heroSide: { src: '/images/locations/rayleigh.jpg', alt: 'Rayleigh editorial location image.', width: 1600, height: 900 },
    },
    maldon: {
      heroSide: { src: '/images/locations/maldon.jpg', alt: 'Maldon editorial location image.', width: 1600, height: 900 },
    },
    'leigh-on-sea': {
      heroSide: { src: '/images/locations/leigh-on-sea.jpg', alt: 'Leigh-on-Sea editorial location image.', width: 1600, height: 900 },
    },
  } as Record<string, { heroSide: ImageSlot }>,
  blog: {
